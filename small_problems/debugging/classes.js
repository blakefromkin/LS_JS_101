...
function toString(date) {
  ...
  // THIS IS NOT HOW .getDay works!! It returns a code for day of the week
  // ALSO NEEDS getFullYear rather than getYear
  // getMonth returns a 0 based value! Need to add 1 to that value for it to work
}
